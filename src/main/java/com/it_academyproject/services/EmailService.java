...
public class EmailService {
	...
	public void notificationEmail() {
    	...
    	for(int i = 0; i < absence.size(); i++) {  
    		...
    		if(counter==8) {    	
    			...
    			if (emailsSent.get(0).isSent() == true) {								////////// TO VERIFY IF WE ALREADY SENT AN EMAIL TO THIS USER /////////////////
    				
    			}else {
    			
	    			Emails emailsListNotification = new Emails();
	    			...
	    			String email = absence.get(i).getUserStudent().getEmail();        //////////  THIS LINE IS COMMENTED JUST FOR TEST PORPOSE ///////////
	    			//String email = "alitunja27@gmail.com";								//////////  PLEASE WRITE A TEST EMAIL TO RECEIVE THE EMAIL /////////
        ...
        for(int i=0;i<finishInXDays.size();i++) {
        	if (finishInXDays.get(i).getEndDate() != null) {
        		...
        		if (daysInt==15) {
        			String email = finishInXDays.get(i).getUserStudent().getEmail();  //////////  THIS LINE IS COMMENTED JUST FOR TEST PORPOSE ///////////
        			//String email = "alitunja27@gmail.com";								//////////  PLEASE WRITE A TEST EMAIL TO RECEIVE THE EMAIL /////////
	...
	/////////////////////////////////////////////   END 15 DAYS OR 30 DAY LEFT NOTIFICATION CODE    ///////////////////////////////////////////////////////////////
